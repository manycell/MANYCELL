...
dnl $HeadURL: https://sbrml.svn.sourceforge.net/svnroot/sbrml/branches/rel-4-0-0/config/libcheck.m4 $
dnl
dnl ---------------------------------------------------------------------------
...
dnl Default minimum version is 0.9.2 because that's the minimum LibSBRML needs.
dnl
...
#include <check.h>
  ...
  LIBSBRML_OPTIONS="$LIBSBRML_OPTIONS USE_LIBCHECK"
