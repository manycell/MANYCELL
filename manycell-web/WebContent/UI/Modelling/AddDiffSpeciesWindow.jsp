...
dojo.event.topic.publish("show_model_name");
 ...
 <h4> Available sub-cellular species for cell-cell differentiations</h4>		
 <s:form action="doStoreDiffSpecies" id="frm_demo"  method="POST" enctype="multipart/form-data">   
 <div id="cellreadroot" >		
	<div id="sDiv">	
	    <s:action name="doAddDiffSpeciesWindow" executeResult="true"/>                                                                      
     </div>   
</div> 
	<table>      			      
     	<tr>     	
 ...
 <hr/>	
 <s:form action="doCellularData" method="POST" enctype="multipart/form-data" target="main">
 <h4> Selected sub-cellular species for cell-cell differentiations</p>
 <table>
 	<tr>
 		<td>Name</td>
 		<td>Initial value</td>
